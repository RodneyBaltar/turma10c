...
public class ManipulaString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Comparação:" + email.contentEquals("humberto@fiap.com.br"));
		System.out.println("Comparação ignorando caixa:" + email.equalsIgnoreCase("HUMBERTO@FIAP.COM.BR"));
